    ...
    <Container title="404">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          ...
          facts about the world of programming.
        </p>
        ...
        <div className="flex flex-col justify-center p-8 relative pb-12 italic text-lg font-bold mb-4 border-2 min-h-[6rem] rounded-xl border border-gray-300">
          ...
          {
            (data) ? <p className="mt-2 self-center text-gray-500 dark:text-gray-300">{data.fact}</p> : <><div className="mt-2 w-3/4 self-center animate-pulse h-8 rounded-lg bg-gray-200 dark:bg-gray-700">&nbsp;</div><div className="sm:hidden mt-4 w-3/4 self-center animate-pulse h-8 rounded-lg bg-gray-200 dark:bg-gray-700">&nbsp;</div></>
            }
        </div>
        </div>
        <Link href="/">
