...
export default function Newsletter({ newsletters }) {
  return (
    <Container
      title="Newsletter"
      description="A collection of my newsletters"
    >
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          I created this page just in case I plan to start sharing newsletters in the far future.
          You won't find any posts here.
        </p>
        <Subscribe />
