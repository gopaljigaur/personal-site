...
export default function ContactForm() {
  ...
  />
    ...
    <textarea
      ...
      autoComplete="off"
      required
      className="px-4 py-2 mb-2 whitespace-pre-wrap focus:ring-blue-500 min-h-[8rem] sm:min-h-[7rem] focus:border-blue-500 block w-full border-gray-300 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
    />
  <button
